...
local function playOpen()
    ...
    TweenService:Create(close, showTween, {BackgroundTransparency = 0, TextTransparency = 0}):Play()
end
...
local function closeUI()
    ...
    TweenService:Create(close, hideTween, {BackgroundTransparency = 1, TextTransparency = 1}):Play()
